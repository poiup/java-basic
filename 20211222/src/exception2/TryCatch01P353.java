...
public class TryCatch01P353 {
	public static void main(String[] args) {
		...
		// 스캐너로 int a,b 에 정수를 입력받는 부분까지만 작성해주세요.
		...
		try {
			...
			// 예외가 발생하면 바로 catch로 넘어감.
			System.out.println(a/b);
			System.out.println("계산끝");
		} catch (Exception e) {
			// catch블록에는 (Exception e) 가 기본적으로 들어갑니다.
			// Execption e로 적는 경우 예외 종류를 막론하고 전부 처리 가능하다.
			// 추후에 특정한 종류의 예외를 따로 처리하고싶은경우는 다른 예외명을 적으면 된다.
			System.out.println("나누는 숫자는 0이 될수 없습니다.");
		} finally {
